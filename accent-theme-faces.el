...
(defun accent-theme-faces (theme-name)
  ...
  (let ((accent-theme--find accent-theme--highlight))
    (custom-theme-set-faces
     ...
     `(font-lock-doc-string-face ((t (:foreground ,accent-theme--text))))
     ...
     `(font-lock-string-face ((t (:foreground ,accent-theme--moss))))
     `(font-lock-type-face ((t (:foreground ,accent-theme--text))))
     ...
     `(diff-added ((t (:foreground ,accent-theme--moss))))
     `(diff-changed ((t (:foreground ,accent-theme--changed))))
     `(diff-removed ((t (:foreground ,accent-theme--fire))))
     ...
     `(diff-refine-added ((t (:background ,accent-theme--added))))
     `(diff-refine-changed ((t (:background ,accent-theme--changed))))
     `(diff-refine-removed ((t (:background ,accent-theme--removed))))
     ...
     `(magit-diff-added-highlight ((t (:background ,accent-theme--added-highlight :foreground ,accent-theme--highlight-foreground :weight bold))))
     ...
     `(magit-diff-removed ((t (:background ,accent-theme--removed :foreground ,accent-theme--highlight-foreground))))
     `(magit-diff-removed-highlight ((t (:background ,accent-theme--removed-highlight :foreground ,accent-theme--highlight-foreground :weight bold))))
     `(magit-diff-whitespace-warning ((t (:background ,accent-theme--removed :foreground ,accent-theme--highlight-foreground))))
     ...
     `(magit-tag ((t (:foreground ,accent-theme--highlight-background))))
