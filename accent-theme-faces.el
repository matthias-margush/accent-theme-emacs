...
(defun accent-theme-faces (theme-name)
  ...
  (let ((accent-theme--find accent-theme--highlight))
    (custom-theme-set-faces
     ...
     `(link ((t (:foreground ,accent-theme--link :underline t :weight bold))))
     ...
     `(outline-2 ((t (:weight normal :foreground ,accent-theme--text))))
     `(outline-3 ((t (:weight normal :foreground ,accent-theme--text))))
     `(outline-4 ((t (:weight normal :foreground ,accent-theme--text))))
     `(outline-5 ((t (:weight normal :foreground ,accent-theme--text))))
     `(outline-6 ((t (:weight normal :foreground ,accent-theme--text))))
     `(outline-7 ((t (:weight normal :foreground ,accent-theme--text))))
     `(outline-8 ((t (:weight normal :foreground ,accent-theme--text))))
     ...
     `(org-code ((t (:inherit fixed-pitch :foreground ,accent-theme--text))))
     ...
     `(org-hide ((t (:foreground ,accent-theme--background))))
     `(org-link ((t (:inherit link))))
     `(org-meta-line ((t (:foreground ,accent-theme--keyword))))
     `(org-drawer ((t (:inherit org-meta-line :weight normal))))
     ...
     `(org-table ((t (:inherit fixed-pitch :foreground ,accent-theme--text))))
