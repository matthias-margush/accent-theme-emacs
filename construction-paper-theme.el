...
(defvar construction-paper-theme--water "#CCDFFC")
...
(defun construction-paper-theme (theme-name)
  ...
  (custom-theme-set-faces
   ...
   `(outline-1 ((t (:weight bold :foreground ,construction-paper-theme--keyword))))
   `(outline-2 ((t (:weight bold :foreground ,construction-paper-theme--keyword))))
   `(outline-3 ((t (:weight bold :foreground ,construction-paper-theme--keyword))))
   `(outline-4 ((t (:weight bold :foreground ,construction-paper-theme--keyword))))
   `(outline-5 ((t (:weight bold :foreground ,construction-paper-theme--keyword))))
   `(outline-6 ((t (:weight bold :foreground ,construction-paper-theme--keyword))))
   `(outline-7 ((t (:weight bold :foreground ,construction-paper-theme--keyword))))
   `(outline-8 ((t (:weight bold :foreground ,construction-paper-theme--keyword))))
   ...
   `(font-lock-negation-char-face ((t (:foreground ,construction-paper-theme--highlight-background))))
   ...
   `(ivy-prompt-match ((t (:background ,construction-paper-theme--highlight-background :foreground ,construction-paper-theme--text))))
   `(ivy-confirm-face ((t (:inherit minibuffer-prompt :foreground ,construction-paper-theme--text))))
   `(ivy-current-match ((t (:weight bold :foreground ,construction-paper-theme--link))))
   ...
   ;; Search
   `(lazy-highlight-background ((t (:background ,construction-paper-theme--highlight-background :foreground ,construction-paper-theme--highlight-foreground :weight normal))))
   ...
   `(isearch ((t (:foreground ,construction-paper-theme--inverted-text :background ,construction-paper-theme--find :weight bold))))
   `(isearch-lazy-highlight-background-face ((t (:foreground ,construction-paper-theme--inverted-text :background ,construction-paper-theme--find))))
   `(lazy-highlight ((t (:foreground ,construction-paper-theme--inverted-text :background ,construction-paper-theme--find))))
   ...
   ;; Company
   `(company-echo-common ((t (:foreground ,construction-paper-theme--keyword))))
   ...
   `(whitespace-line ((t (:background ,construction-paper-theme--text :foreground ,construction-paper-theme--good))))
   `(whitespace-newline ((t (:foreground ,construction-paper-theme--doc))))
   `(whitespace-space ((t (:background ,construction-paper-theme--text :foreground ,construction-paper-theme--doc))))
   ...
   `(magit-section-heading ((t (:inherit variable-pitch :foreground ,construction-paper-theme--keyword))))
   `(magit-section-heading-selection ((t (:inherit variable-pitch :foreground ,construction-paper-theme--alert))))
   ...
   `(org-document-title ((t (:foreground ,construction-paper-theme--keyword :weight bold))))
