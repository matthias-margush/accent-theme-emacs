...
(defun construction-paper-theme (theme-name)
  ...
  (custom-theme-set-faces
   ...
   `(ivy-current-match ((t (:weight bold :background ,construction-paper-theme--highlight-background :foreground ,construction-paper-theme--link))))
   ...
   `(diff-refine-added ((t (:background ,construction-paper-theme--moss :foreground ,construction-paper-theme--inverted-text))))
   `(diff-refine-changed ((t (:background ,construction-paper-theme--sun :foreground ,construction-paper-theme--inverted-text))))
   `(diff-refine-removed ((t (:background ,construction-paper-theme--fire :foreground ,construction-paper-theme--inverted-text))))
