...
(defun construction-paper-theme (theme-name)
  ...
  (custom-theme-set-faces
   ...
   `(company-template-field ((t (:background "#56585A" :foreground "#F3F2EE"))))
   `(company-tooltip ((t (:background "#505254" :foreground "#F3F2EE"))))
   `(company-tooltip-mouse ((t (:background "#505254" :foreground "#F3F2EE"))))
   `(company-tooltip-annotation ((t (:foreground "##505254"))))
   `(company-tooltip-common ((t (:weight bold :background "#505254" :foreground "#F3F2EE"))))
   `(company-tooltip-common-selection ((t (:weight bold :background "#3a3a3a" :foreground  "#F3F2EE"))))
   `(company-tooltip-selection ((t (:background "#3a3a3a" :foreground  "#F3F2EE"))))
