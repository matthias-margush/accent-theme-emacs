...
(defun construction-paper-theme (theme-name)
  ...
  (custom-theme-set-faces
   ...
   `(spacebar-active ((t (:inherit variable-pitch :background ,construction-paper-theme--background :foreground ,construction-paper-theme--nav :height 1.2 :weight normal))))
   `(spacebar-inactive ((t (:inherit variable-pitch :background ,construction-paper-theme--background :foreground ,construction-paper-theme--deemphasize :weight normal :height 1.2))))
   ...
   `(company-preview-common ((t (:weight bold :foreground ,construction-paper-theme--text :height 1.1))))
   `(company-preview-search ((t (:weight bold :foreground ,construction-paper-theme--text :height 1.1))))
   `(company-scrollbar-bg ((t (:background ,construction-paper-theme--inverted-background :height 1.1))))
   `(company-scrollbar-fg ((t (:background ,construction-paper-theme--inverted-background :height 1.1))))
   `(company-template-field ((t (:inherit region :background ,construction-paper-theme--highlight-background :foreground ,construction-paper-theme--text :height 1.1))))
   `(company-tooltip ((t (:background ,construction-paper-theme--inverted-background-medium :foreground ,construction-paper-theme--inverted-text :height 1.1))))
   `(company-tooltip-annotation ((t (:foreground ,construction-paper-theme--light-dark :height 1.1))))
   `(company-tooltip-common ((t (:background ,construction-paper-theme--inverted-background-medium :foreground ,construction-paper-theme--inverted-text :height 1.1))))
   `(company-tooltip-common-selection ((t (:background ,construction-paper-theme--inverted-background-medium :foreground ,construction-paper-theme--inverted-text :height 1.1))))
   `(company-tooltip-selection ((t (:weight bold :background ,construction-paper-theme--inverted-background :foreground ,construction-paper-theme--inverted-text :height 1.1))))
