...
(defun construction-paper-theme (theme-name)
  ...
  (custom-theme-set-faces
   ...
   ;; Company
   `(company-echo-common ((t (:foreground ,construction-paper-theme--sky))))
   `(company-preview ((t (:height 1.1 :foreground ,construction-paper-theme--highlight-background))))
   `(company-preview-common ((t (:weight bold :foreground ,construction-paper-theme--highlight-background))))
   `(company-preview-search ((t (:weight bold :foreground ,construction-paper-theme--highlight-background))))
   ...
   `(company-tooltip-annotation ((t (:foreground ,construction-paper-theme--highlight-background))))
